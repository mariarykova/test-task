...
const EditModal = ({ open, setOpen, role }) => {
  /////////////////////////////////////// VARIABLES ///////////////////////////////////////
  ...
  return (
    <Dialog
      ...
      <DialogTitle className="flex items-center justify-between">
        <div className="text-sky-400 font-primary">{role === "Employee" ? "Edit Employee" : "Edit Client"}</div>
      ...
      <DialogContent>
        <div className="flex flex-col gap-2 p-3 text-gray-500 font-primary">
          <div className="text-xl flex justify-start items-center gap-2 font-normal">
            <PiNotepad size={23} />
            <span>{role === "Employee" ? "Employee Detials" : "Client Detials"}</span>
          </div>
          <Divider />
